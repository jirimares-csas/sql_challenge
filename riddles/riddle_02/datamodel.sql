...
create table polybius_square_ciphers_solution (cipher_id integer, dec_message_cz varchar2(1000), dec_message_en varchar2(1000));
...
insert into polybius_square_ciphers_solution (cipher_id, dec_message_cz, dec_message_en)
values
(1,
'ZPRAVA',
'MESSAGE');
